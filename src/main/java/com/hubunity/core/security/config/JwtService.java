...
public class JwtService {
    ...
    private static final String MASTER_COMPANY_ID = "e21a3330-bb0a-44da-ab84-f83a58e701b6dd";
    ...
    public String extractIdEmpresa(String token) {
        return extractClaim(token, claims -> claims.get("id_empresa", String.class));
    }
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        if (userDetails instanceof User) {
            ...
            if (customUser.getRole() == Role.ADMIN) {
                ...
                idEmpresa = customUser.getEmpresa().getId();
            }
            extraClaims.put("id_empresa", idEmpresa);
        }
